...
const DeletedIntrazoneFilter = (
  ...
  return (
    <>
        <>
       <div className="table_filter_container border_radius_7px p-3 deleted_intra_zone">
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <div className="mt-3 col-lg-6">
            {RenderSelectField("main_zone_id", "Intra Zone ID", true)}
          </div>
          ...
          <div className="mt-3 d-lg-flex gap-3">
            {RenderSelectField("city_name", "Intra Zone Name")}
          </div>
          <span className="d-flex justify-content-start fs_14 fw_500 primary_color my-2 ps-5 ms-5">
            -(or)-
          </span>
...
export default DeletedIntrazoneFilter
