...
const RiderCouponFilter = ({
  filter,
  handleFilterClose,
  search,
  riderCouponDropDownList,
  type = "",
}) => {
  const selectOptions = (key) =>
    Object.values(riderCouponDropDownList[key] || {}).map((item) => ({
      value: item[key],
      label: item[key],
    }));
  ...
  return (
    <div className="table_filter_container border_radius_7px p-3">
      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        <div className="mt-3 col-lg-6">
          {RenderSelectField("coupon_code", "Coupon Code")}
        </div>
        <span className="d-flex justify-content-start fs_14 fw_500 primary_color my-2 ps-5 ms-5">
          -(or)-
        </span>
        ...
        <div className="mt-3 d-lg-flex gap-3">
        <div className="my-3 my-lg-0">
          {RenderSelectField("coupon_title", "Coupon Title")}
          </div>
        ...
        <div className="mt-3 d-lg-flex gap-3"></div>
...
export default RiderCouponFilter;
