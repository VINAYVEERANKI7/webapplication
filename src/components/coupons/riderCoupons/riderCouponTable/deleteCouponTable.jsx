...
import { deletedCouponAllViewAction } from "../../../../redux/actions/riderCoupon/createCouponAction";
...
const RiderCouponsDeleted = ({ search }) => {
                  ...
                  <tr key={id} className={"light_blue_bg text-nowrap"}>
                    ...
                    <td className="">
                      <NavLink
                        ...
                        to={`/coupon-deleted-view/${item?.id}`}
                        state={{
                          edit: false,
...
export default RiderCouponsDeleted;
