...
import { myComplaintsListAction } from "../../redux/actions/complaints/myComplaintsAction";
...
import DriverComplaintChatBox from "../chat-section/driver-complaint-chat-box";

const DriverComplaintChat = ({ type, navLoaction }) => {
                      ...
                      <div className="d-flex justify-content-end align-items-center me-sm-2 gap-2">
                        <div className="position-relative">
                          <div
                            ...
                            onClick={() => setDriverDetails(!driverDetails)}
                            ref={onClickRef}
                          >
                            <span>Details</span>
                          </div>
...
export default DriverComplaintChat;
