...
const ManageDriverRideHistoryTable = ({
  rideData,
  loading,
  error,
  handlePagination,
  ...
  return (
    <>
      ...
      <div className={`${styles.rider_history_table_container}`}>
        ...
        <table className={`table ${style.manage_fare_list_navbar} text-nowrap`}>
          <thead>
            <tr className="orange_bg ">
              <th scope="col" className={`${style.first_list}`}>
              ...
              <th scope="col" className={`${styles.last_list} transparent_bg`}>
                <span className="white_color fs_14   text-nowrap d-flex align-items-center fw_500">
                  Final Fare(₹)
                </span>
              </th>
...
export default ManageDriverRideHistoryTable;
