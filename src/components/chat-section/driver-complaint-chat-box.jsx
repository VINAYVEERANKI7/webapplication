...
import {
  ...
  DriverSendComplaintMessageAction,
  storedMessageAction,
...
const DriverComplaintChatBox = ({
  ...
  const handleSend = async () => {
    if (currentMessage !== "" || file !== null) {
      ...
      // await socket.emit("admin_sending_complaint_msg_to_driver", messageData);
  ...
  useEffect(() => {
    socket.on("driver_sending_complaint_msg_to_admin", (data) => {
      console.log(data, "driver_sending_complaint_msg_to_admin");
      setChangesMade(data);
      setShouldScrollToBottom(true);
    ...
    return () => {
      socket.off("driver_sending_complaint_msg_to_admin");
    };
  }, [socket]);
...
export default DriverComplaintChatBox;
