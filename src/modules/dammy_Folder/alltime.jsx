...
function Alltime() {
    ...
    const tableData = [
        ...
        { city: 'Bangalore', searches: '10,55,90,305', searcheswg: "10,46,40,879", searchesfq: "8,26,93,167", searcheswgq: "4,85,98,786", bookings: "4,77,98,192", ongoingtrips: "3,03,83,241", onlineDrivers: '3,213' },
        { city: 'Kolkata', searches: '1,29,03,679', searcheswg: "1,10,98,307", searchesfq: "77,95,266", searcheswgq: "46,91,227", bookings: "38,10,301", ongoingtrips: "22,40,642", onlineDrivers: '3,654' },
        { city: 'Chennai', searches: '15,86,711', searcheswg: "14,40,549", searchesfq: "9,80,468", searcheswgq: "7,49,114", bookings: "6,72,265", ongoingtrips: "4,60,213", onlineDrivers: '298' },
        { city: 'Kochi', searches: '13,98,463', searcheswg: "12,82,741", searchesfq: "5,23,763", searcheswgq: "3,41,803", bookings: "3,40,030", ongoingtrips: "1,84,357", onlineDrivers: '5,098' },
        { city: 'Mysore', searches: '4,06,688', searcheswg: "4,02,022", searchesfq: "2,33,247", searcheswgq: "2,17,613", bookings: "2,13,044", ongoingtrips: "1,41,899", onlineDrivers: '2,784' },
        { city: 'Hyderabad', searches: '5,03,896', searcheswg: "4,47,156", searchesfq: "2,16,302", searcheswgq: "80,530", bookings: "79,108", ongoingtrips: "32,869", onlineDrivers: '987' },

        { city: 'Delhi', searches: '1,43,586', searcheswg: "1,14,101", searchesfq: "45,500", searcheswgq: "16,233", bookings: "15,879", ongoingtrips: "6,248", onlineDrivers: '1,213' },
    ];
                ...
                <div style={{ display: "flex" }}>
                    <div className='three greenbg'>
                        <div style={{ display: "flex" }}>
                            ...
                            {showInfoPopup &&
                                <div className="blackpopupallg">
                                    ...
                                    <div style={{ display: "flex" }} >
                                        <p style={{ marginTop: "-7px" }}><span style={{ color: 'rgb(177, 171, 171)', marginLeft: "10px" }}>3,33,15,864</span>
                                            &nbsp;&nbsp;<span style={{ color: 'rgb(177, 171, 171)', fontSize: "10px" }}>------------</span></p>
                                        <p style={{ marginTop: "-15px", marginLeft: "1%" }}>Overall completed</p>
                                    </div>
                                    ...
                                    <div style={{ display: "flex" }} >
                                        ...
                                        <p style={{ marginTop: "-15px", marginLeft: "6%" }}>Yesterday's</p>
                                    </div>
                                    <p style={{ marginTop: "-24px", marginLeft: "54%" }}>Completed Trips</p>
                                </div>
                            }
                        ...
                        <p className='oneeightstyles'>
                            <span>1.36L<i class='bx bx-up-arrow-alt'></i></span></p>
                    </div>
                    ...
                    <div className='three bluebg'>
                        <div style={{ display: "flex" }}>
                            ...
                            {showsecondInfoPopup &&
                                <div className="blackpopupalltimes">
                                    ...
                                    <p style={{ marginTop: "-10px" }}><span style={{ marginLeft: "12px", color: 'rgb(177, 171, 171)' }}>12,19,97,261</span>&nbsp;&nbsp;
                                        <span style={{ color: 'rgb(177, 171, 171)', fontSize: "10px" }}>--------------</span>&nbsp;&nbsp;Overall Searches</p>
                                    <p style={{ marginTop: "-10px" }}><span style={{ color: 'rgb(177, 171, 171)', marginLeft: "12px", backgroundColor: "#E8E9EB", borderRadius: "3px" }}>5,50,485
                                        <i class='bx bx-up-arrow-alt' style={{ fontSize: "20px", marginTop: "-15px" }}></i></span>&nbsp;&nbsp;
                                        <span style={{ color: 'rgb(177, 171, 171)', fontSize: "10px" }}>-----------------</span>&nbsp;&nbsp;Yesterday Searches</p>
                                </div>
                        ...
                        <p className='twosevenstyles'>
                            <span>5.5L<i class='bx bx-up-arrow-alt'></i></span></p>
                    </div>
                    ...
                    <div className='three orangebg'>
                        <div>
                            <div style={{ display: "flex" }}>
                                ...
                                {showthirdInfoPopup &&
                                    <div className='blackpopupallo'>
                                        ...
                                        <div style={{ display: "flex" }} >
                                            <p style={{ marginTop: "-7px" }}><span style={{ color: 'rgb(177, 171, 171)', marginLeft: "10px" }}>₹4,98,83,49,641</span>
                                                &nbsp;&nbsp;
                                            </p>
                                            <p style={{ marginTop: "-15px", marginLeft: "3%" }}>Overall Driver's</p>
                                        </div>
                            ...
                            <p className='onesixstyles'><span>₹2.01Cr<i class='bx bx-up-arrow-alt'></i></span></p>
                        </div>
                    </div>
                ...
                <div style={{ display: "flex" }}>
                    ...
                    <div className='three lightbluebg'>
                        <div style={{ display: "flex" }}>
                            ...
                            <i className='bx bx-info-circle infostyles' onMouseEnter={handlefiveInfoHover} onMouseLeave={handlefiveInfoLeave}></i>
                            {showfiveInfoPopup &&
                                <div className="blackpopupfive">
                                    <div style={{ display: "flex" }} >
                                        <p style={{ marginTop: "16px" }}><span style={{ color: 'rgb(177, 171, 171)', marginLeft: "10px" }}>57,66,748</span>
                                            &nbsp;&nbsp;<span style={{ color: 'rgb(177, 171, 171)', fontSize: "10px" }}>------------</span></p>
                                        <p style={{ marginTop: "5px", marginLeft: "1%" }}>Overall Registered</p>
                                    </div>
                                    ...
                                    <p style={{ marginTop: "-24px", marginLeft: "51%" }}>Registered Users</p>
                                </div>
                            }
                        ...
                        <p className='fivesevenstyles'>
                            <span>13.33K<i class='bx bx-up-arrow-alt'></i></span></p>
                    </div>

                    <div className='three pinkbg'>
                        <div style={{ display: "flex" }}>
                            <p className='Completedtrips'>Enabled Drivers</p>
                            <i className='bx bx-info-circle infostyles' onMouseEnter={handlesixInfoHover} onMouseLeave={handlesixInfoLeave}></i>
                            {showsixInfoPopup &&
                                <div className="blackpopupsix">
                                    <div style={{ display: "flex" }} >
                                        <p style={{ marginTop: "27px" }}><span style={{ color: 'rgb(177, 171, 171)', marginLeft: "10px" }}>3,33,15,864</span>
                                            &nbsp;&nbsp;<span style={{ color: 'rgb(177, 171, 171)', fontSize: "10px" }}>------------</span></p>
                                        <p style={{ marginTop: "15px", marginLeft: "1%" }}>Overall Enabled</p>
                                    </div>
                                    <p style={{ marginTop: "-24px", marginLeft: "49%" }}>Drivers</p>
                                    ...
                                    <div style={{ display: "flex" }} >
                                        ...
                                        <p style={{ marginTop: "-15px", marginLeft: "8%" }}>Yesterday's Enabled</p>
                                    </div>
                                    <p style={{ marginTop: "-24px", marginLeft: "49%" }}>Drivers</p>
                                </div>
                            }
                        ...
                        <p className='onesevenstyles'>
                            <span>1.74KL<i class='bx bx-up-arrow-alt'></i></span></p>
                    </div>
                </div>
                <div>
                    <div style={{ display: "flex" }}>
                            ...
                            <tr style={{ backgroundColor: "#dfe3e4" }}>
                                <th>
                                    ...
                                    <i
                                        ...
                                        className={`bx ${sortColumn === 'city' && sortDirection === 'asc'
                                                ? 'bx-up-arrow-alt'
                                                : 'bx-down-arrow-alt'
                                            }`}
                                ...
                                <th>Searches
                                    <i
                                        style={{ marginLeft: '5px', cursor: 'pointer' }}
                                        className={`bx ${sortColumn === 'searches' && sortDirection === 'asc'
                                                ? 'bx-down-arrow-alt'
                                                : 'bx-up-arrow-alt'
                                            }`}
                                ...
                                <th>Searches
                                    <i style={{ marginLeft: "15px", cursor: 'pointer' }}
                                        className={`bx ${sortColumn === 'searcheswg' && sortDirection === 'asc'
                                                ? 'bx-down-arrow-alt'
                                                : 'bx-up-arrow-alt'
                                            }`}
                                ...
                                <th>Searches
                                    <i style={{ marginLeft: "15px", cursor: "ponter" }}
                                        className={`bx ${sortColumn === 'searchesfq' && sortDirection === 'asc'
                                                ? 'bx-down-arrow-alt'
                                                : 'bx-up-arrow-alt'
                                            }`}
                                ...
                                <th>Searches
                                    <i style={{ marginLeft: "15px", cursor: "pointer" }}
                                        className={`bx ${sortColumn === 'searcheswgq' && sortDirection === 'asc'
                                                ? 'bx-down-arrow-alt'
                                                : 'bx-up-arrow-alt'
                                            }`}
                                ...
                                <th>Bookings
                                    <i style={{ marginLeft: "15px", cursor: "pointer" }}
                                        className={`bx ${sortColumn === 'bookings' && sortDirection === 'asc'
                                                ? 'bx-down-arrow-alt'
                                                : 'bx-up-arrow-alt'
                                            }`}
                                ...
                                <th>Completed
                                    <i style={{ marginLeft: "15px", cursor: "pointer" }}
                                        className={`bx ${sortColumn === 'ongoingtrips' && sortDirection === 'asc'
                                                ? 'bx-down-arrow-alt'
                                                : 'bx-up-arrow-alt'
                                            }`}
                                ...
                                <th>
                                    ...
                                    <i
                                        style={{ marginLeft: '5px', cursor: 'pointer' }}
                                        className={`bx ${sortColumn === 'onlineDrivers' && sortDirection === 'asc'
                                                ? 'bx-down-arrow-alt'
                                                : 'bx-up-arrow-alt'
                                            }`}
